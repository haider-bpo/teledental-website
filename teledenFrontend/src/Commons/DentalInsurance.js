    ...
    <div>
      ...
      <div className="cosmetic-pd-wrapper footer-center-pages">
        ...
        <p>
          ...
          teledental or live teledentistry as well. People can do a{" "}
          <em>live dentist consultation</em> and a <em>virtual dental exam</em>{" "}
          - and have it covered by some dental insurance companies. They can
          perhaps in some locations even be given dental antibiotics Rx if
          needed. There are limitations to any of these dental services.
        </p>
      </div>
    </div>
  );
